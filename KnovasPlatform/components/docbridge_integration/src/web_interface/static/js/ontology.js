...
const KEYWORD_PACK = [
    ...
    [/gesetz|erlass|artikel|paragraf|norm|verordnung|richtlinie|entscheid|urteil|regest/, 'book'],
    [/rechtsgebiet|rechtsbereich|fachgebiet|sachgebiet|thema|schlagwort/, 'tag'],
