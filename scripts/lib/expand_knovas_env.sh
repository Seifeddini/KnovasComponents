...
DOCBRIDGE_WEB_PORT="$(read_knovas DOCBRIDGE_WEB_PORT 8081)"
...
PLATFORM_DB_USER PLATFORM_BROKER_KEY_DIR DOCBRIDGE_WEB_PORT RC_HOST_PORT
...
${LOGIN_LINES}
DOCBRIDGE_WEB_PORT=${DOCBRIDGE_WEB_PORT}
